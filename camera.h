...
public:
    ...
    void get_camera_pos()
    {
        camera_posX = 200+r_x/2+jump_translate_x;
        camera_posY = 200+jump_translate_y;
        camera_posZ = -200+r_z/2+jump_translate_z;
        look_posX = 120+r_x/2+jump_translate_x;
        look_posY = jump_translate_y;
        look_posZ = -35+r_z/2+jump_translate_z;
    }
...
public:
    ...
    {
        camera_posX = r_x/2+jump_translate_x;
        camera_posY = 25 + jump_translate_y;
        camera_posZ = r_z/2+jump_translate_z - 85;
        look_posX = r_x/2+jump_translate_x-20*sin(DEG2RAD(ba));
        look_posY = 25 + jump_translate_y;
        look_posZ = r_z/2+jump_translate_z+20*cos(DEG2RAD(ba))-85;
...
public:
    ...
    void get_camera_pos(float ba)
    {
        camera_posX = r_x/2+jump_translate_x  + 5*sin(DEG2RAD(ba));
        camera_posY = 3.0 + jump_translate_y;
        camera_posZ = r_z/2+jump_translate_z - 5*cos(DEG2RAD(ba));
        look_posX = r_x/2+jump_translate_x;
        look_posY = jump_translate_y;
        look_posZ = r_z/2+jump_translate_z;
        if(falling)
